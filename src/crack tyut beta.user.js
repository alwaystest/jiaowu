...
/*********************************************
 * add chrome support !!!bug: can't remove alert(). once alert ,can't pg();
 *
 * ******************Notes********************
 *
...
if ( typeof unsafeWindow === "undefined" ||  ! bGreasemonkeyServiceDefined) {//For chrome  get unsafeWindow.
	unsafeWindow    = ( function () {
		var dummyElem   = document.createElement('p');
		dummyElem.setAttribute ('onclick', 'return window;');
		return dummyElem.onclick ();
	} ) ();
	console.log("unsafeWindow  Set");
}else {
	var Sys=getBrowser(); 
